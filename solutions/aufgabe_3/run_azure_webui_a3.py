...
# Aufgabe 3: Hier haben wir für dich das Embeddings Modell schon einmal initialsiert
...
# Aufgabe 3: Erzeuge dir einen VectoreStore aus den Dokument mithilfe der ChromaDB

# Aufgabe 3: Lade dir relvante Dokumente mit der Vectorestore Similiarity Search
...
def predict(message, history):
    ...
    # Aufgabe 3: Füge als Context die Dokumente hinzu, die Dokument kommen nun als Liste, 
    # unter utils git es eine Hilfsfunktion formatDocs, welche die Dokumente in ein "schöneres" Format bringt.
