...
# Aufgabe 4: Splitte die Dokumente in kleinere Chunks (z.B. 100 Zeichen lang)
...
# Aufgabe 4: erzeuge den VectorStore aus den Chunks
vectorStore = Chroma.from_documents(documents, embeddings)

# Aufgabe 4: (Optional) Probiere die Similiarity Search with Score aus, und filtere Dokumente nach Score
